.PHONY: help bootstrap install lint format typecheck test dev-api dev-worker dev-up dev-down clean
...
dev-api:
	$(UV) run --package liftwork-api uvicorn liftwork_api.main:app --reload --host 0.0.0.0 --port 8000
